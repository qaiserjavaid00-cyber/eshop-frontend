    ...
    return (
        <div className="border p-4 rounded space-y-3">
            <div className="flex gap-2">
                <input {...register(`variants.${index}.size`)} placeholder="Size" className="border p-2 w-full uppercase" />
                <input {...register(`variants.${index}.color`)} placeholder="Color" className="border p-2 w-full uppercase" />
