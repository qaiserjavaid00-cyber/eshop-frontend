    ...
    return (
        <Dialog open={isOpen} onClose={onClose} className="relative z-50">
            ...
            <div className="fixed inset-0 flex items-center justify-center p-4">
                <Dialog.Panel className="bg-white dark:bg-background rounded-2xl p-6 max-w-sm w-full shadow-lg space-y-4">
                    ...
                    <div className="flex justify-end gap-2">
                        <button onClick={onClose} className="text-sm px-4 py-2 bg-gray-100 text-black">
                            Cancel
                        </button>
                        <button
