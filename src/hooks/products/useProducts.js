...
export const useProducts = ({ search, color = [], size = [], category = [], subCategory = [], brand = [], tags = [], specifications = {}, minPrice, maxPrice, sort, initialPage = 1, limit = 12, }) => {
    ...
    const {
        ...
        queryKey: [
            "products",
            { page, search, color, size, category, subCategory, brand, tags, specifications, minPrice, maxPrice, sort, limit },
        ],
        queryFn: () => {
            const payload = {
                page,
