...
//             <Banner title="shop" imageUrl="https://res.cloudinary.com/dfgeq4iix/image/upload/v1772447486/mern-ecommerce/nygat7mhpccrtbih6o5i.jpg"
//             />
    ...
    return (
        <>
            ...
            <div className="max-w-6xl mx-auto">
                <div className="flex">
                    {/* FILTERS */}
                    <div className="hidden md:flex flex-col w-1/4 p-6 gap-3 border shadow-lg rounded-lg">
                        {filtersContent}
                    </div>

                    {/* Mobile Filters */}

                    <div className="w-full md:w-3/4 md:ml-3">
                        ...
                        <div className="md:hidden mb-4">
                            <Sheet>
                                ...
                                <SheetTrigger asChild>
                                    <button className="border px-4 py-2 rounded-md text-sm font-medium shadow-sm">
                                        Filters
                                    </button>
                                </SheetTrigger>
