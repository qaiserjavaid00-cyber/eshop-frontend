...
import ProductServiceHighlights from '@/components/product/ProductServicesHighlights';
...
export const ProductDetails = () => {
    ...
    return (
        <>
            <div className="max-w-6xl mx-auto flex flex-col lg:flex-row border border-gray-100 dark:border-none p-4 gap-6">
                    ...
                    >
                        {displayImages.map((img, index) => (
                            <div key={index} className="w-full h-[420px] md:h-[520px] flex items-center justify-center bg-gray-50 rounded-xl">
                                <img src={img} alt={`product-${index}`} className="hover:scale-105 duration-300 w-full h-full object-cover rounded-xl" />
                            </div>
                        ))}
                    </Slider>
                            ...
                            <div className="flex gap-2 flex-wrap">
                                {sizes.map(size => (
                                    <button
                                        ...
                                        className={`px-2 py-1 border rounded-lg text-xs ${selectedSize === size ? "dark:bg-gray-500 bg-gray-300" : ""}`}
                                    >
                                        {size}
                                    </button>
                                ))}
                            ...
                            <div className="flex gap-2 flex-wrap">
                                {colors.map(color => (
                                    <button
                                        ...
                                        className={`px-2 py-1 border rounded text-xs ${selectedColor === color ? "dark:bg-gray-500 bg-gray-300" : ""}`}
                                    >
                                        {color}
                                    </button>
                                ))}
                ...
                <div className='flex flex-col'>
                    ...
                    <Button
                        ...
                        size="sm"
                        className="p-1 rounded-full mt-3"
                    >
                        Add to Wishlist
                    </Button>
                    <Button
